#!/usr/bin/env julia
#
# Note: Nothing changed in this script. Only broken URLs removed.
#
function printsum(a)
    # generates a summary of an object
...
# (note this is a "jagged array" (i.e., an array of arrays),
# not a multidimensional array, these are not covered here)

# Julia provided a number of dequeues functions, the most common for appending
# to the end of arrays is push!
